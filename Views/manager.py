...
def manager():
    ...
    btn1 = Button(w, text='View Customers', width=20, height=2, bg='#141414', fg='white', command=view_customer)
    btn1.place(x=100, y=100)

    btn2 = Button(w, text='Add Service', width=20, height=2, bg='#141414', fg='white', command=add_service)
    btn2.place(x=100, y=200)

    btn3 = Button(w, text='Add User', width=20, height=2, bg='#141414', fg='white', command=add_customer)
